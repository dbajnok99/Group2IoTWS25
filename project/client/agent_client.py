...
MCP_URL = "http://127.0.0.1:4200/mcp/" # il tuo Starlette MCP - your starlette MCP
...
BASE_URL = "http://localhost:11434/v1" # <-- cambia a LM Studio se vuoi - check out LM Studio if you want
